...
class QuestionSolution(Base):
    ...
    status: Mapped[str] = mapped_column(String(16), nullable=False, default="draft")
    answer_package_json: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    visualization_plan_json: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
...
class VisualizationRow(Base):
    ...
    interactive_hints_json: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    helpers_used_json: Mapped[dict] = mapped_column(JSONB, nullable=False, default=list)
    engine: Mapped[str] = mapped_column(String(16), nullable=False, default="geogebra")
